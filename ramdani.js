...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© By Nando Ganss","listType": "SINGLE_SELECT","sections": list}}, {})
...
"externalAdReply": {
                ...
                "body": `${faketroli}`,
                "mediaType": "10",
                "mediaUrl": `https://youtube.com/channel/RenandoOke`,
                "thumbnailUrl": "https://youtube.com/channel/RenandoOke",
                "thumbnail": fakeimg,
                "sourceUrl": `https://youtube.com/channel/RenandoOke`,
      ...
      const demoteAdmin = async function(to, target=[]){
          ...
          if (!packname) packname = 'Dibuat Oleh'; if (!author) author = '© Nando Ganss';author = author.replace(/[^a-zA-Z0-9]/g, '');	
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const troli =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 500, status: 200, thumbnail: fakeimage, surface: 200, message: faketroli, orderTitle: 'KIRIK', sellerJid: '0@s.whatsapp.net'} } }
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/foto/thumb.jpg`)},"title": `© ʙʏ Nando Ganss`,"description": "KIRIK BOT", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Nando Ganss","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
danzrun = process.uptime() 
           Ramdani.setStatus(`${namabot} Aktif Selama ${(danzrun)} © Creator By Nando Ganss`).catch((_)=>_); //DI UBAH YATIMM
...
> 532 ${prefix}nsfw_avatar`
               ...
               buttonsMessage = {
               contentText: `${allmenu}`,
               footerText: '© Nando Ganss', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
// SOSMET          
      ...
      if (!isRegist) return freply(mess.regist)
      if (isBanned) return freply(mess.banned)
             freply(`Follow Instagram Owner Ya : https://www.instagram.com/renando_okee`)
             break
//casee nya
case 'grupbot':
case 'groupbot':
